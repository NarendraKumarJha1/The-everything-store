            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-2">
                    <div class="main-card">
                        ...
                        <img class="product-img" src="https://github.com/nitinpandey02/The-everything-store/blob/experimental/public/imgs/mobile1.png?raw=true" alt="" />
                    </div>
                    ...
                    <div class="parent">
                        <div class=" child">
                            <div class="similar-product">
                                <img class="testimonial-img" src="https://github.com/nitinpandey02/The-everything-store/blob/experimental/public/imgs/mobile1.png?raw=true" alt="" />
                                <h4>REDMI 9 Prime</h4>
                                <h6>(Sunrise Flare, 64 GB) <br /> (4 GB RAM)</h6>
                        ...
                        <div class=" child">
                            <div class="similar-product">
                                <img class="testimonial-img" src="https://github.com/nitinpandey02/The-everything-store/blob/experimental/public/imgs/mobile2.png?raw=true" alt="" />
                                <h4>POCO C3</h4>
                                <h6>(Arctic Blue, 64 GB) <br /> (4 GB RAM)</h6>
                        ...
                        <div class="child">
                            <div class="similar-product">
                                <img class="testimonial-img" src="https://github.com/nitinpandey02/The-everything-store/blob/experimental/public/imgs/mobile3.png?raw=true" alt="" />
                                <h4>Realmi-Narzo</h4>
                                <h6>5G (Sword Black, 64 GB) <br /> (6 GB RAM)</h6>
                        ...
                        <div class="child">
                            <div class="similar-product">
                                <img class="testimonial-img" src="https://github.com/nitinpandey02/The-everything-store/blob/experimental/public/imgs/mobile4.jpg?raw=true" alt="" />
                                <h4>Redmi-9A</h4>
                                <h6>(Midnight Black, 32 GB) <br /> (2 GB RAM)</h6>
